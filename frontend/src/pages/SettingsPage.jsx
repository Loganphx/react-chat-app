        ...
        <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
                    {THEMES.map((t) => (
                        <button key={t}
                                className={`group flex flex-col items-center gap-1.5 p-2 rounded-lg tranisition-colors ${theme === t ? "bg-base-200" : "hover:bg-base-200/50"}`}
                                onClick={() => setTheme(t)}
                        >
                ...
                <div className="rounded-xl border border-base-300 overflow-hidden bg-base 100 shadow-lg">
                    <div className="p-4 bg-base-200">
                        {/* Mock Chat UI */}
                        <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden w-[60%] mx-auto">
                            {/* Chat Header */}
